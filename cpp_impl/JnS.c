...
// rem: oes not depend on n,of course: virer l'argument
	     ...
	     )
{
  ...
  // iohavoc: dec13,2001 modification, whiten matrix before
  // passing it in, all we do here is cum. est & joint diag.
